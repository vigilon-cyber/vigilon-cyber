...
export const QUESTIONS: Record<string, Question> = {
  ...
  core_function: question({
    ...
    hint: 'Only the core function counts. Integrating a component such as a browser or firewall doesn’t by itself change the category. Important and critical products are listed below.',
    summaryLabel: 'CRA product category',
    explainer: {
      summary: 'View the product lists',
      body: [
        'Important, Class I:',
          ' - Identity management and privileged access management systems, including authentication and access control readers',
          ...
          ' - Smart home products with security functionalities, such as smart door locks, security cameras, baby monitoring systems and alarm systems',
          ' - Internet-connected toys with social interactive or location tracking features',
          ' - Personal wearables with a health monitoring purpose not covered by medical device rules, or intended for use by children.',
        'Important, Class II:',
